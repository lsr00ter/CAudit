            ...
            for entry1 in entry_generator1:
                ...
                for entry2 in entry_generator2:
                    ...
                    for entry3 in entry_generator3:
                        ...
                        entry_generator4 = (
                            self.ldap_cli.con.extend.standard.paged_search(
                                search_base=ldap_cli4,
                                search_filter=query,
                                search_scope=BASE,
                                get_operational_attributes=True,
                                attributes=attributes,
                        ...
                        for entry4 in entry_generator4:
                            if entry4["attributes"][
                                "msExchSmtpOutboundSecurityFlag"
                            ] & int("0b100000000000000000000000", 2):
                                result["status"] = 1
                                instance = {}
