...
class PluginADConstrainedDelegationWithDC(PluginADScanBase):
    ...
    def run_script(self, args) -> dict:
        ...
        for entry in entry_generator:
            ...
            instance = {}
            if (
                isinstance(entry["attributes"]["msDS-AllowedToDelegateTo"], list)
                and len(entry["attributes"]["msDS-AllowedToDelegateTo"]) != 0
            ):
                result["status"] = 1
                instance["主机名"] = entry["attributes"]["cn"]
                instance["DN"] = entry["attributes"]["distinguishedName"]
                instance["msDS-AllowedToDelegateTo"] = entry["attributes"][
