...
class PluginADIllegalPrimaryGroupIDAccount(PluginADScanBase):
    ...
    def run_script(self, args) -> dict:
        ...
        attributes = ["cn", "primaryGroupID", "memberof", "distinguishedName"]
        ...
        primary_list = {
            ...
            521: "Enterprise Read-only Domain Controllers",
            544: "Administrator",
        ...
        for entry in entry_generator:
            ...
            if int(entry["attributes"]["primaryGroupID"]) in primary_list.keys():
                ...
                instance["所在组"] = primary_list[
                    int(entry["attributes"]["primaryGroupID"])
                ]
            else:
                result["status"] = 1
                instance = {}
